...
$sql = "SELECT*FROM informations WHERE sexe='M'";
...
<body>
    ...
    <div class="conteneur1">
        <div class="carree">
            <p class="para1">DATE DU CONCOURS</p>
            <HR color="#f9f990">
        ...
        <div class="carree">
            <p class="para1">LIMITE DU DEPOT DES DOSSIERS</p>
            <HR color="#f9f990"><br>
            <br>
            <p><a href="" class="bout1">Fixer une date</a></p>
        </div>
        <div class="carree">
            <p class="para1">NOMBRE TOTAL DE CANDIDATS: </p>
            <HR color="#f9f990"><br>
            <?php echo $resultat4["Nb"]?>
            <br>
        </div>
        <div class="carree">
            <p class="para1">NOMBRE DE CANDIDATS PAR SEXE</p>
            <HR color="#f9f990">
            <table>
                <tr>
    ...
    <div class="conteneur2">
        <center><p class="p1">Listes de tous les candidats masculins inscrits</p></center>
        <br>
    <table class="table">
        <tr>
