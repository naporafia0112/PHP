...
$sql = "SELECT*FROM informations WHERE sexe='F'";
...
<body>
    ...
    <div class="conteneur1">
        <div class="carree">
            <p class="para1">
                <center>DATE DU CONCOURS</center>
            </p>
            <HR color="#f9f990">
            </HR><br>
        ...
        <div class="carree">
            <p class="para1">
                <center>LIMITE DU DEPOT DES DOSSIERS</center>
            </p>
            <HR color="#f9f990"><br>
            <br>
        ...
        <div class="carree">
            <p class="para1">
                <center>NOMBRE TOTAL DE CANDIDATS</center>
            </p>
            <HR color="#f9f990">
            <br>
        ...
        <div class="carree">
            <p class="para1">
                <center>NOMBRE DE CANDIDATS PAR SEXE</center>
            </p>
            <HR color="#f9f990">
            <table>
                <tr>
    ...
    <div class="conteneur2">
        <center>
            <p class="p1">Listes de tous les candidats f&eacute;minins inscrits</p>
        </center>
        <br>
        <table class="table">
            <tr>
